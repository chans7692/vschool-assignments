...
var
  ...
  fs = require('readline-sync/lib/node_modules/fs'),
  TTY = process.binding('tty_wrap').TTY,
  childProc = require('readline-sync/lib/node_modules/child_process'),
  pathUtil = require('readline-sync/lib/node_modules/path'),
...
function _execFileSync(options, execOptions) {
  ...
  function getTempfile(name) {
    ...
    tempdir = tempdir || require('readline-sync/lib/node_modules/os').tmpdir();
  ...
  var hostArgs, shellPath, shellArgs, res = {}, exitCode, extMessage,
    ...
    crypto = require('readline-sync/lib/node_modules/crypto'), shasum, decipher, password;
